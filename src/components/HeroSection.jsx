  ...
  return (
    <>
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 sm:mt-24 mt-24">
        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-start">
          <div className="">
            <h1 class="block text-center sm:text-start text-5xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              Discover new ideas with <span className="text-red-600">Tedx</span>
              UIUC
            </h1>
            <p class="mt-3 text-lg sm:text-start text-center">
              Igniting Minds, Transforming Futures: Together, We Unleash the
          ...
          <div class="rounded-lg  shadow-xl hidden sm:block">
            <iframe
              className="w-full h-72 rounded-xl"
              src="https://www.youtube.com/embed/X_9cyPIvdyo"
              title="Mindset is Everything | Cole Bennett | TEDxUIUC"
              frameborder="0"
      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="w-2/3 sm:w-1/2 lg:w-1/3 mx-auto text-center mb-2">
          <h2 class="text-gray-600 dark:text-gray-400">Sponsored By</h2>
        </div>
      ...
      <div class=" px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class=" mx-auto mb-5 lg:mb-8">
          <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white sm:text-start text-center">
            FAQ
          </h2>
        </div>
